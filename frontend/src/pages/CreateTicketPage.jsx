...
export default function CreateTicketPage() {
  ...
  const validateStep1 = () => {
    ...
    if (!form.faculty) {
      setError("Please select your Faculty / School.");
      return false;
    }
  ...
  const submit = async () => {
    ...
    setError("");
    try {
      // Send form data cleanly — no description prefix
      const payload = {
        title: form.title,
    ...
    <div style={{ maxWidth: "700px", margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        <p style={{ margin: "4px 0 0", color: "#666", fontSize: "0.9rem" }}>
          Please complete this form and a technician will be assigned as soon as
          possible.
        </p>
      </div>
                ...
                background:
                  step === i + 1
                    ...
                    : step > i + 1
                      ...
                      : "#f1f3f4",
                color:
                  step === i + 1 ? "white" : step > i + 1 ? "#155724" : "#888",
      ...
      {step === 1 && (
        <div style={ss}>
          ...
          <p
            style={{ color: "#666", fontSize: "0.85rem", marginBottom: "20px" }}
          >
            Please complete this form and one of our technicians will reply as
            soon as possible.
          </p>
        ...
        <div style={ss}>
          ...
          >
            ...
            {form.priority === "MEDIUM" &&
              "🟡 Will be addressed within 2–3 working days."}
            {form.priority === "HIGH" &&
              "🔴 Will be addressed within 24 hours."}
            {form.priority === "CRITICAL" &&
              "🚨 Emergency — technician will respond immediately."}
          </div>
          ...
          <div style={{ marginBottom: "18px" }}>
            ...
            <p style={hs}>
              Describe the issue — when it started, how it affects you, what you
              have tried.
            </p>
            <textarea
              style={{
      ...
      {step === 3 && (
        <div style={ss}>
              ...
              {[
                ...
                <tr key={k} style={{ borderBottom: "1px solid #f0f0f0" }}>
                  ...
                  >
                    {k === "Priority" ? (
                      <span
                        style={{ color: PRIORITY_COLORS[v], fontWeight: "600" }}
                      >
                        ● {v}
                      </span>
                    ) : (
          ...
          >
            🤖 AI triage will automatically analyze your ticket after
            submission.
          </div>
        </div>
      )}
